"""Claim vs evidence verdict engine (vendored from TruthGraph)."""
...
def verify_claim(
    ...
    for evidence in evidence_items:
        relevance, keywords = calculate_relevance(claim.text, evidence.text)
        stance = classify_evidence(claim, evidence, relevance)
